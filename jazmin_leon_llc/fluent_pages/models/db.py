...
class HtmlPage(Page):
    ...
    seo_translations = TranslatedFields(
        ...
        meta_description=models.CharField(_('description'), max_length=255, blank=True,
            default='', help_text=_("Typically, about 160 characters will be shown in search engines")),
        meta_title=models.CharField(_('page title'), max_length=255, blank=True, default='',
            help_text=_("When this field is not filled in, the menu title text will be used.")),
        meta_image=AnyImageField(_('example image'), null=True, blank=True, default='', on_delete=models.CASCADE, help_text=_("This allows social media sites to pick a default image.")),
        meta=dict(
